...
ngdbuild -uc ..\..\example_design\example_chipscope_icon.ucf -p xc3s250e-cp132-4 -sd . example_chipscope_icon.ngc example_chipscope_icon.ngd
REM Check Results
...
REM Run map
ECHO 'Running MAP'
map -w -p xc3s250e-cp132-4 -o example_chipscope_icon.map.ncd example_chipscope_icon.ngd
REM Check Results
